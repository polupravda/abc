  ...
  return (
    <div className={`w-full ${className}`}>
      <button
        ...
        className="w-full flex items-center gap-5 py-5 px-6 rounded-lg bg-indigo-100 hover:bg-indigo-200 transition-colors text-left focus:outline-none focus:ring-2 focus:ring-indigo-400"
