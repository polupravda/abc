...
export const ButtonSpeak: React.FC<ButtonProps> = ({
  text,
  ...
  return (
    <button
      className={`p-4 h-[10rem] w-[10rem] flex flex-col items-center justify-start gap-2 shadow-lg/20 text-purple-300 bg-gradient-to-br from-purple-400 to-purple-600 hover:bg-gradient-to-r hover:from-purple-500 hover:to-purple-700 rounded-full focus:outline-none transition-colors ${
        className || ""
      }`}
      {...props}
    >
      ...
      <span className="font-bold text-2xl text-wrap text-white drop-shadow-md/30">
        {text}
      </span>
    </button>
  );
