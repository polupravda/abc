...
"use client";
;
const VerticalSlider = ({ value, onChange, min = -15, max = 15, step = 1, height = "500px" })=>{
    _s();
    const range = max - min;
    ...
    const handleInteraction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "VerticalSlider.useCallback[handleInteraction]": (clientY)=>{
    ...
    }["VerticalSlider.useCallback[handleInteraction]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VerticalSlider.useEffect": ()=>{
            const handleMouseMove = {
                "VerticalSlider.useEffect.handleMouseMove": (event)=>{
                    if (isDragging) {
                        handleInteraction(event.clientY);
                    }
                }
            }["VerticalSlider.useEffect.handleMouseMove"];
            const handleTouchMove = {
                "VerticalSlider.useEffect.handleTouchMove": (event)=>{
                    if (isDragging && event.touches.length > 0) {
                        handleInteraction(event.touches[0].clientY);
                    }
                }
            }["VerticalSlider.useEffect.handleTouchMove"];
            const handleMouseUpOrTouchEnd = {
                "VerticalSlider.useEffect.handleMouseUpOrTouchEnd": ()=>{
                    setIsDragging(false);
                }
            }["VerticalSlider.useEffect.handleMouseUpOrTouchEnd"];
            if (isDragging) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: Array.from({
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `absolute left-1/2 transform -translate-x-1/2 h-px pointer-events-none ${isMajorTick ? "w-3 bg-gray-600" : "w-2 bg-gray-400"}`,
                                style: {
                                    top: `${stepPosition}%`
                                }
                            }, stepValue, false, {
...
_s(VerticalSlider, "EwCYHgBxAKSqAjcojEg8ynWCawo=");
_c = VerticalSlider;
...
//# sourceMappingURL=app_9819765b._.js.map